...
export default function DashboardView({ onMudarAba }: { onMudarAba?: (aba: 'contribuicao-estatutaria' | 'credenciais') => void }) {
      ...
      {loadingData ? (
        ...
        !erro && (
          <div className="flex flex-col items-center justify-center py-20 gap-4 text-gray-400">
            ...
            {onMudarAba && (
              <button onClick={() => onMudarAba('contribuicao-estatutaria')}
