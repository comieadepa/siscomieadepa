...
export const TEMPLATE_MINISTRO_CLASSICO_CUSTOMIZADO: TemplateCartaoCustomizado = {
  ...
  elementosVerso: [
    ...
    {"id":"17777572943580y7bte3zo","tipo":"texto","x":27,"y":109,"largura":261,"altura":20,"fontSize":13,"cor":"#000","fonte":"Akshar Semibold","texto":"REG. CGADB:&nbsp;{registro_cgadb}","alinhamento":"left","negrito":true,"italico":false,"sublinhado":false,"visivel":true},
