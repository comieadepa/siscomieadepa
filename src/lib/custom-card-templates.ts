...
export const TEMPLATE_MINISTRO_CLASSICO_CUSTOMIZADO: TemplateCartaoCustomizado = {
  ...
  elementosVerso: [
    ...
    { id: '17672016286477ygtl2bbk', tipo: 'texto', x: 29, y: 22, largura: 303, altura: 24, fontSize: 10, cor: '#000', fonte: 'Arial', texto: '<font color="#ef4444">{filiacao}</font>', alinhamento: 'left', negrito: true, italico: false, sublinhado: false, visivel: true },
