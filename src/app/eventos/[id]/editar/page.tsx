    ...
    async function loadEvento() {
      ...
      try {
        ...
        if (res.ok) {
          ...
          const tipos = (j.tipos ?? []) as Array<{ nome: string; valor: number; inclui_alimentacao: boolean; inclui_hospedagem: boolean; ativo: boolean }>;
          if (tipos.length > 0) {
            ...
            {form.usar_tipos_inscricao && (
              <div className="md:col-span-2">
                ...
                <p className="mt-2 text-xs text-gray-400">
                  Ative apenas os tipos que o evento oferece. Hospedagem e alimentacao sao marcadas automaticamente na inscricao conforme o tipo escolhido.
                </p>
              </div>
            )}
