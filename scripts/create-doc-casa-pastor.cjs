...
export default function DocCasaDoPastor({ membro, dadosIgreja, fotoUrl }: DocCasaDoPastorProps) {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      ...
      <div ref={fichaRef} style={{ width: '210mm', margin: '0 auto', padding: '8mm 10mm', fontFamily: 'Arial, sans-serif', fontSize: '11px', lineHeight: '1.35', backgroundColor: '#fff', color: '#222', boxSizing: 'border-box' }}>
          ...
          <tbody>
            <tr>
              ...
              <td style={{ textAlign: 'center', verticalAlign: 'middle' }}>
                <div style={{ fontSize: '26px', fontWeight: 'bold', letterSpacing: '8px', color: '#0D2B4E' }}>
                ...
                <div style={{ fontSize: '14px', fontStyle: 'italic', fontWeight: 'bold', color: '#0D2B4E', marginTop: '6px' }}>
                  Encaminhamento Para:
                </div>
                <div style={{ fontSize: '16px', fontWeight: 'bold', color: '#0D2B4E', letterSpacing: '1px' }}>
        ...
        <div style={{ borderTop: '2px solid #0D2B4E', marginBottom: '8px' }} />

        {/* TABELA PRINCIPAL */}
        <table style={{ width: '100%', borderCollapse: 'collapse' }}>
          <tbody>

            {/* Linha 1: Cadastro/ACP | Registro/COMIEADEPA | Status */}
            <tr>
              <td style={lbl}>Cadastro/ACP</td>
              <td style={{ ...cell, width: '120px' }}></td>
              <td style={lbl}>Registro/COMIEADEPA</td>
              <td style={{ ...cell, width: '80px' }}>{fmt(membro.matricula)}</td>
            ...
            {/* Linha 2: Nome + foto (rowspan) */}
            <tr>
              <td style={lbl}>Nome</td>
              <td colSpan={4} style={{ ...cell, fontWeight: 'bold', fontSize: '13px' }}>
                {membro.nome.toUpperCase()}
              </td>
              <td rowSpan={6} style={{ ...cell, width: '88px', verticalAlign: 'top', padding: '4px', textAlign: 'center' }}>
                {fotoUrl
                  ? <img src={fotoUrl} alt={membro.nome} style={{ width: '80px', height: '100px', objectFit: 'cover', border: '1px solid #bbb' }} />
            ...
            {/* Linha 3: Categoria | Registro CGADB */}
            <tr>
            ...
            {/* Linha 4: Nascimento | Tipo Sanguineo */}
            <tr>
            ...
            {/* Linha 5: RG | CPF | Data de Filiacao */}
            <tr>
              <td style={lbl}>RG</td>
            ...
            {/* Linha 6: Pai | Estado Civil */}
            <tr>
              <td style={lbl}>Pai</td>
              <td colSpan={2} style={cell}>{fmt(membro.nomePai).toUpperCase()}</td>
            ...
            {/* Linha 8: Conjuge | Nascimento */}
            <tr>
              <td style={lbl}>Conjuge</td>
              <td colSpan={2} style={{ ...cell, fontWeight: 'bold' }}>{fmt(membro.nomeConjuge).toUpperCase()}</td>
              <td style={lbl}>Nascimento</td>
              <td colSpan={2} style={cell}>{fmtDate(membro.dataNascimentoConjuge)}</td>
            </tr>

            {/* Linha 9: Nacionalidade | Naturalidade */}
            <tr>
            ...
            {/* Linha 13: Batismo/Aguas | local/Batismo */}
            <tr>
            ...
            {/* Linha 16: Ordenacao ao Pastor | Local */}
            <tr>
            ...
            {/* Linha 19: OBSERVACOES header */}
            <tr>
              <td colSpan={6} style={{ ...cell, background: '#fff', fontWeight: 'bold', color: '#dc2626', textAlign: 'right', fontSize: '11px', border: '1px solid #bbb', paddingRight: '8px' }}>
                OBSERVACOES
              </td>
            </tr>

            {/* Linha 20-22: Area de observacoes */}
            <tr>
              <td colSpan={6} style={{ ...cell, height: '60px', verticalAlign: 'top' }}>
                {fmt(membro.observacoes)}
              </td>
            </tr>
            <tr>
              <td colSpan={6} style={{ ...cell, height: '30px' }}></td>
            </tr>
            <tr>
              <td colSpan={6} style={{ ...cell, height: '30px' }}></td>
            </tr>
...
console.log('DocCasaDoPastor.tsx criado. Linhas: ' + content.split('\n').length);
