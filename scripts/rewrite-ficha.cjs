                ...
                <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td style={{ ...cell, fontWeight: 'bold' }}>{fmt(membro.posicaoNoCampo).toUpperCase()}</td>
                    </tr>
                    <tr>
...
const dest = path.join(__dirname, '..', 'src', 'components', 'FichaMembro.tsx');
fs.writeFileSync(dest, content, { encoding: 'utf8' });
console.log('FichaMembro.tsx reescrito. Linhas: ' + content.split('\n').length);
