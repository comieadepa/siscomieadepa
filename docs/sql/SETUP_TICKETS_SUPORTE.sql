-- Execute this SQL in your Supabase console to create the tickets_suporte table
...
CREATE INDEX IF NOT EXISTS idx_tickets_data_criacao ON tickets_suporte(data_criacao DESC);
...
-- RLS Policy: Users can update their own tickets
